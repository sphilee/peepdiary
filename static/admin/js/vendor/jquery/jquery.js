...
(function( global, factory ) {
	...
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// See ticket #14549 for more user.
...
function on( elem, types, selector, data, fn, one ) {
	...
	if ( one === 1 ) {
		...
		fn = function( event ) {
			...
			// Can use an empty set, since event contains the user
			jQuery().off( event );
	...
	jQuery.cssHooks[ name ] = {
		get: function( elem, computed, extra ) {
			if ( computed ) {
				...
				// Certain elements can have dimension user if we invisibly show them
